...
//    this->setMaximumSize(300,300);
    ...
    //----------------------------
    UIClavier* clavier = new UIClavier(wdg);
    clavier->addLine(line1);
    clavier->addLine(line2);
    clavier->addLine(line3);
    clavier->addLine(line4);
    clavier->addSpace();
    clavier->addLine(line5);
    clavier->addLine(line6);
    clavier->addLine(line7);
    clavier->addSpace();
    clavier->addLine(line8);


    wdg->setLayout(clavier);
